...
export interface ClusterOptions {
    ...
    */
    ...
    /**
     * The AWS credential options to scope the cluster's kubeconfig when using a
...
export class Cluster extends pulumi.ComponentResource {
    ...
    constructor(name: string, args?: ClusterOptions, opts?: pulumi.ComponentResourceOptions) {
        ...
        // Enforce that cred options are provided to scope the kubeconfig to
        // the same credentials if using an AWS provider instance, AWS_PROFILE,
        // or a profile configured on the AWS provider.
